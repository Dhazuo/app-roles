        ...
        <template v-slot:content>
            ...
            <div class="w-full space-y-4">
                ...
                <div class="flex space-x-2">
                    ...
                    <input v-if="product.image == null" type="file" accept="image/*" @change="onFileChange"
                           class="">
                </div>
                <div class="">
                    <h1 v-if="product.image == null" class="text-red-500">No has seleccionado ninguna imagen</h1>
